...
from FL_pruning_algorithm.fedDUAP.flearn.models.base_model import BaseModel

from FL_pruning_algorithm.fedDUAP.flearn.models.linear import DenseLinear

from FL_pruning_algorithm.fedDUAP.flearn.models.conv2d import DenseConv2d
from FL_pruning_algorithm.fedDUAP.flearn.utils.model_utils import is_fc, is_conv
...
class Bottleneck(nn.Layer):
    # Bottleneck in vision places the stride for downsampling at 3x3 convolution(self.conv2)
...
class ResNet(BaseModel):
    ...
    def get_pt_model(self):
        from FL_pruning_algorithm.fedDUAP.flearn.models.resnet import resnet18
