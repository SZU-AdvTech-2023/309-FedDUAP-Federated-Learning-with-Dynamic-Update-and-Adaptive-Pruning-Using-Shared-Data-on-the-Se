...
from FL_pruning_algorithm.fedDUAP.flearn.utils.model_utils import traverse_module, is_conv, is_fc, is_bn, is_norm_conv
...
class BaseModel(nn.Layer, ABC):
    ...
    def loss(self, inputs, labels: paddle.Tensor) -> paddle.Tensor:
